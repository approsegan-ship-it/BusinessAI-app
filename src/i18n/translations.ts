...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
  ...
  es: {
    ...
    'nav.images': 'Imágenes y Diseños IA',
  ...
  ar: {
    ...
    'nav.images': 'مولّد الصور والتصاميم',
