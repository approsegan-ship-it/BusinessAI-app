...
export const PRICING_PLANS: Record<PlanId, PricingPlan> = {
  free: {
    ...
    tagline: 'Idéal pour découvrir la puissance de l’IA',
    description: 'Testez nos générateurs de textes et démarrez la communication de votre entreprise sans aucun frais.',
    features: [
      '10 générations IA par mois',
      'Générateur de publications (Facebook, Insta, WhatsApp, Slogans)',
      'Générateur de fiches produits persuasives',
      'Réponses clients (7 modèles essentiels)',
      'Partage des résultats (WhatsApp & Copie rapide)',
      'Historique standard (10 derniers contenus)',
    ],
    maxUsers: 1,
    historyLimit: 10,
    supportLevel: 'Communautaire / FAQ',
    colorScheme: {
  ...
  business: {
    ...
    features: [
      'Utilisation importante (2 000 générations IA / mois)',
...
export const COMPARISON_MATRIX: ComparisonRow[] = [
  ...
  },
  {
    ...
    featureName: 'Générateur de publications',
    free: true,
    starter: true,
    pro: true,
    business: true,
